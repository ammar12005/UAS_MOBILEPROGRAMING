...
// --- STORAGE SERVICE FINAL - PASTI WORK ---
class StorageService {
  ...
  static Future<void> setSession(User user) async {
    try {
      ...
      // Simpan status login sebagai STRING (lebih reliable)
  ...
  static Future<User?> getSession() async {
    try {
      // Cek status login (sebagai STRING)
  ...
  // Debug function - untuk cek isi Hive
  static void debugPrintAllData() {
    print('📦 === DEBUG: ISI HIVE DATABASE ===');
    for (var key in _box.keys) {
      print('   Key: $key');
      print('   Value: ${_box.get(key)}');
      print('   ---');
    }
    print('📦 === END DEBUG ===');
  }
